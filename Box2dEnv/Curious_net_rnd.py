...
class Net(nn.Module):
    ...
    def __init__(self, n_states, n_hidden=64):
        ...
        self.fc4 = nn.Linear(n_hidden_2, n_hidden_2)
        ...
        torch.nn.init.kaiming_normal_(self.fc4.weight.data)
        # self.out.weight.data = torch.mul(self.out.weight.data, 5)
        # self.fc1.weight.data = torch.mul(self.fc1.weight.data, 2)
        # self.fc2.weight.data = torch.mul(self.fc2.weight.data, 2)
        # self.fc3.weight.data = torch.mul(self.fc3.weight.data, 2)
        # self.fc4.weight.data = torch.mul(self.fc4.weight.data, 2)
